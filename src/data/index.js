export const categories = [
  ...
  { id: 'chatbot', name: 'AI对话', icon: 'message-circle', tabName: 'AI对话' },
  { id: 'writing', name: 'AI写作', icon: 'pen-tool', tabName: 'AI写作' },
  { id: 'image', name: 'AI图像', icon: 'image', tabName: 'AI图像' },
  { id: 'video', name: 'AI视频', icon: 'video', tabName: 'AI视频' },
  { id: 'office', name: 'AI办公', icon: 'briefcase', tabName: 'AI办公' },
  { id: 'agent', name: 'AI智能体', icon: 'bot', tabName: 'AI智能体' },
  { id: 'programming', name: 'AI编程', icon: 'code', tabName: 'AI编程' },
  { id: 'design', name: 'AI设计', icon: 'palette', tabName: 'AI设计' },
  { id: 'audio', name: 'AI音频', icon: 'music', tabName: 'AI音频' },
  { id: 'search', name: 'AI搜索', icon: 'search', tabName: 'AI搜索' },
  { id: 'framework', name: 'AI开发', icon: 'box', tabName: 'AI开发' },
  { id: 'model', name: 'AI模型', icon: 'cpu', tabName: 'AI模型' },
  { id: 'detection', name: 'AI检测', icon: 'shield', tabName: 'AI检测' },
  { id: 'prompt', name: 'AI提示词', icon: 'sparkles', tabName: 'AI提示词' },
  { id: 'learning', name: 'AI学习', icon: 'graduation-cap', tabName: 'AI学习' }
]
...
export const news = [
  {
    id: 1,
    title: "GPT-5 即将发布，性能大幅提升",
    description: "据内部消息，OpenAI 正在准备 GPT-5 的发布，预计性能将比 GPT-4 提升 300%，支持多模态理解和生成。",
    category: "行业动态",
    date: "2024-01-15"
  },
  {
    id: 2,
    title: "AI 绘画工具推荐：Midjourney vs Stable Diffusion",
    description: "本文对比分析了目前最流行的两款 AI 绘画工具，帮助你选择最适合自己的创作工具。",
    category: "使用技巧",
    date: "2024-01-14"
  },
  {
    id: 3,
    title: "国产大模型迎来爆发期，文心一言 4.0 发布",
    description: "百度正式发布文心一言 4.0 版本，多项能力达到国际领先水平，支持 100 多种语言。",
    category: "行业动态",
    date: "2024-01-13"
  },
  {
    id: 4,
    title: "如何用 AI 提升写作效率？5 个实用技巧",
    description: "分享 5 个使用 AI 写作工具的实用技巧，让你的写作效率提升 10 倍。",
    category: "使用技巧",
    date: "2024-01-12"
  },
  {
    id: 5,
    title: "AI 视频生成工具盘点，一键生成专业视频",
    description: "盘点目前最热门的 AI 视频生成工具，从文字到视频只需几分钟。",
    category: "工具推荐",
    date: "2024-01-11"
  },
  {
    id: 6,
    title: "AI 编程助手：让代码编写更高效",
    description: "介绍几款优秀的 AI 编程助手，帮助开发者提升编码效率和代码质量。",
    category: "使用技巧",
    date: "2024-01-10"
  }
]
...
export function filterTools(categoryId, searchQuery) {
  let filtered = tools
